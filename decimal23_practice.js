/**
 * Decimal23 Practice Page Implementation
 */
document.addEventListener('DOMContentLoaded', function() {
    // Create the page class that extends the base PracticePage
    class Decimal23PracticePage extends PracticePage {
        constructor() {
        ...
        fetchQuestion() {
            ...
            fetch('/api/decimal23/practice/question')
    ...
    // Initialize the page
    const decimal23PracticePage = new Decimal23PracticePage();
});