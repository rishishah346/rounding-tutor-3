/**
 * Decimal1 Examples Page Implementation
 */
document.addEventListener('DOMContentLoaded', function() {
    // Create the page class that extends the base ExamplePage
    class Decimal1ExamplePage extends ExamplePage {
        constructor() {
        ...
        fetchFirstExample() {
            ...
            // Fetch the first example data
            fetch('/api/decimal1/examples/first')
        ...
        loadSecondExample() {
            ...
            fetch('/api/decimal1/examples/second')
                .then(response => response.json())
                .then(data => {
                    this.hideLoading();
        ...
        navigateToPractice() {
            ...
            fetch('/api/decimal1/examples/complete', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
    ...
    // Initialize the page
    const decimal1ExamplePage = new Decimal1ExamplePage();
});